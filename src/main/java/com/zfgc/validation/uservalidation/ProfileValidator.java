...
public class ProfileValidator extends AbstractValidator<Users>{
	...
	public void validator(Users model) throws Exception {
		if(!StringUtils.isNullOrEmpty(model.getPersonalInfo().getCustomTitle())){
		...
		if(!StringUtils.isNullOrEmpty(model.getPersonalInfo().getPersonalText())){
		...
		if(!StringUtils.isNullOrEmpty(model.getPersonalInfo().getLocation())){
		...
		if(!StringUtils.isNullOrEmpty(model.getPersonalInfo().getWebsiteTitle())){
		...
		if(!StringUtils.isNullOrEmpty(model.getPersonalInfo().getWebsiteUrl())){
