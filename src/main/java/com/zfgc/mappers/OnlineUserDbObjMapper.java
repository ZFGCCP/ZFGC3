...
public interface OnlineUserDbObjMapper {
     ...
     * @mbggenerated Fri Jan 18 00:00:38 EST 2019
     */
    int updateByExampleSelective(@Param("record") OnlineUserDbObj record, @Param("example") OnlineUserDbObjExample example);
     ...
     * @mbggenerated Fri Jan 18 00:00:38 EST 2019
     */
    int updateByExample(@Param("record") OnlineUserDbObj record, @Param("example") OnlineUserDbObjExample example);
}