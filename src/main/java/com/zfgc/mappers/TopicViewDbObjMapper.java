...
public interface TopicViewDbObjMapper {
     ...
     * @mbg.generated Sun Jun 07 11:57:10 EDT 2020
     */
    int updateByExampleSelective(@Param("record") TopicViewDbObj record, @Param("example") TopicViewDbObjExample example);
     ...
     * @mbg.generated Sun Jun 07 11:57:10 EDT 2020
     */
    int updateByExampleWithBLOBs(@Param("record") TopicViewDbObj record, @Param("example") TopicViewDbObjExample example);
