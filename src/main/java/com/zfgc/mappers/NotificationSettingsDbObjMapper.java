...
public interface NotificationSettingsDbObjMapper {
     ...
     * @mbggenerated Mon Feb 13 22:55:47 EST 2017
     */
    List<NotificationSettingsDbObj> selectByExample(NotificationSettingsDbObjExample example);
     ...
     * @mbggenerated Mon Feb 13 22:55:47 EST 2017
     */
    int updateByExampleSelective(@Param("record") NotificationSettingsDbObj record, @Param("example") NotificationSettingsDbObjExample example);
     ...
     * @mbggenerated Mon Feb 13 22:55:47 EST 2017
     */
    int updateByExample(@Param("record") NotificationSettingsDbObj record, @Param("example") NotificationSettingsDbObjExample example);
