CREATE TABLE `users` (
	...
	`EMAIL_ADDRESS` VARCHAR(254) NULL DEFAULT NULL,
	...
	`AVATAR_ID` INT(11) NULL DEFAULT '1',
	...
	`HIDE_AIM_FLAG` BIT(1) NOT NULL DEFAULT b'0',
	`HIDE_YIM_FLAG` BIT(1) NOT NULL DEFAULT b'0',
	...
	CONSTRAINT `FK_USERS_AVATAR_ID` FOREIGN KEY (`AVATAR_ID`) REFERENCES `AVATAR` (`AVATAR_ID`),
